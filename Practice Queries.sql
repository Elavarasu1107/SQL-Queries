...
SELECT LTRIM('  Elavarasu  ')
SELECT RTRIM('  Elavarasu  ')
SELECT LEN('  Elavarasu  ')
SELECT LEFT('Elavarasu', 3)
SELECT RIGHT('Elavarasu', 5)
...
WHERE ED.NAME = (SELECT NAME FROM EMP_ADDRESS WHERE NAME = 'Elavarasu')

SELECT * FROM EMPLOYEES_DETAILS
INSERT INTO EMPLOYEES_DETAILS VALUES('Ansari','M',9765421300,'ansari@gmail.com','2022-06-23',101)
INSERT INTO EMP_ADDRESS VALUES('Ansari','18D','Namakkal','Tamil Nadu',654123)
...
SELECT LOWER('ELAVARASU')
SELECT UPPER('appusamy')
SELECT GETDATE()
SELECT DAY(GETDATE())
